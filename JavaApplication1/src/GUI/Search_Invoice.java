...
public class Search_Invoice extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Invoice ID", "Customer mobile", "Total price", "Date"
            }
        ) {
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        ResultSet rs=DBMS.search("SELECT * FROM invoice WHERE `id`='"+id+"'");
        try {
            if(rs.next()){
                String mobile=rs.getString("mobile");
                String price=rs.getString("total_amt");
                String date=rs.getString("date");
                String name=null;
                
                ResultSet r=DBMS.search("SELECT * FROM customer WHERE `mobile`='"+mobile+"'");
                if(r.next()){
            ...
            Logger.getLogger(Search_Invoice.class.getName()).log(Level.SEVERE, null, ex);
        }
